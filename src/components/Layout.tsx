...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      if (window.innerWidth >= 1024) {
        ...
        circleRef.current.style.top = "40%";
  ...
  return (
    <>
      <div
        ref={circleRef}
        className="bg-[#d2afff]/30 rounded-full w-[30vmax] h-[60vmax] sm:w-[30vmax] sm:h-[30vmax] fixed transition-all duration-150 ease-linear"
